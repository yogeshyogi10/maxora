...
const brokenPart = `                  We aim to provide end-to-end solutions — from website development to social media management and SEO — enabling our clients to build credibility, attract customers, and scale their business in the digital world.
                </p>
              >
...
const fixedPart = `                  We aim to provide end-to-end solutions — from website development to social media management and SEO — enabling our clients to build credibility, attract customers, and scale their business in the digital world.
                </p>
              </div>
...
file = file.replace(brokenPart, fixedPart);
